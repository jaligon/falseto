...
public class SmithWatermanInverseSigmoid extends SessionComparison {
    ...
    public ArrayList<ArrayList<Qfset>> getAlignment() {
        CellInfoEditDistance maxCi = new CellInfoEditDistance(Integer.MIN_VALUE, 0, 0, Generics.EditDistanceOperatorType.NOOPERATION, 0);
    ...
    public QuerySession getFutureLogQueries (ALIGNMENT_TYPE alignmentType) {
        CellInfoEditDistance maxCi = new CellInfoEditDistance(0, 0, 0, Generics.EditDistanceOperatorType.NOOPERATION, 0);
